...
def completed_annual_housing_units():
    ...
    df_final.columns = [
        'year', 'single_family_total', 'single_family_built_for_sale', 'single_family_fee_simple', 'single_family_contractor_built',
        'single_family_owner_built', 'single_family_detached', 'single_family_attached', 'single_family_median_square_feet',
        'single_family_average_square_feet', 'multi_family_total', 'multi_family_for_sale', 'multi_family_for_rent',
        'multi_family_2_to_4_units', 'multi_family_5_to_9_units', 'multi_family_10_to_19_units', 'multi_family_20_or_more_units',
        'multi_family_median_square_feet_per_unit', 'multi_family_average_square_feet_per_unit'
    ]
